...
```{r, message=FALSE, warning=FALSE}
simulacao_monte_carlo <- function(n_simulacoes, n_amostra, alpha_verdadeiro, mu_verdadeiro, sigma_verdadeiro){
...
Aqui, inicialmente a primeira simulação teremos os seguintes valores de $\alpha = 0.6$ e $\mu = 2$ e $\sigma^2 = 4$, e distribuição `Binomial Negativa`.  
...
```{r, message=FALSE, warning=FALSE}
resultados_binomial_50 <- simulacao_monte_carlo(n_simulacoes = 5000, n_amostra = 50, alpha_verdadeiro = 0.6, mu_verdadeiro = 2, sigma_verdadeiro = 3)
```

```{r}
paste0("Com tamanho de amostra 50 e via mínimos quadrados condicionais, temos o seguinte alpha médio: ", round(resultados_binomial_50$media_Minimos_Quadrados_condicionais[1], 4)," para o lambda Médio: ", round(resultados_binomial_50$media_Minimos_Quadrados_condicionais[2], 4))

paste0("Com tamanho de amostra 50 e via Máxima Verossimilhança Condicional, temos o seguinte alpha médio: ",   round(resultados_binomial_50$media_Maxima_verossimilhanca_condicional[1], 4)," para o lambda Médio: ", round(resultados_binomial_50$media_Maxima_verossimilhanca_condicional[2], 4))

paste0("Com tamanho de amostra 50 e via Mínimos Quadrados Condicionais, temos a variância do alpha: ", 
       round(resultados_binomial_50$variancia_Minimos_Quadrados_condicionais[1], 4), " e a variância para o lambda: ", 
       round(resultados_binomial_50$variancia_Minimos_Quadrados_condicionais[2], 4))

paste0("Com tamanho de amostra 50 e via Máxima Verossimilhança Condicional, temos a variância do alpha: ", 
       round(resultados_binomial_50$variancia_Maxima_verossimilhanca_condicional[1], 4), " e a variância para o lambda: ", 
       round(resultados_binomial_50$variancia_Maxima_verossimilhanca_condicional[2], 4))

```

```{r}
banco_binomial_50_min_quad <- as.data.frame(resultados_binomial_50[[5]])
banco_binomial_50_max_vero <- as.data.frame(resultados_binomial_50[[6]])
```
...
```{r, warning=FALSE, message=FALSE}
grafico_50_min_quad_lambda <- ggplot(banco_binomial_50_min_quad) +
 aes(x = V2) +
...
```{r, warning=FALSE, message=FALSE}
grafico_50_min_quad_alpha <- ggplot(banco_binomial_50_min_quad) +
 aes(x = V1) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_50_max_vero_lambda <- ggplot(banco_binomial_50_max_vero) +
 aes(x = V2) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_50_max_vero_alpha <- ggplot(banco_binomial_50_max_vero) +
 aes(x = V1) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, message=FALSE, warning=FALSE}
resultados_binomial_100 <- simulacao_monte_carlo(n_simulacoes = 5000, n_amostra = 100, alpha_verdadeiro = 0.6, mu_verdadeiro = 2, sigma_verdadeiro = 3)

```

```{r}
paste0("Com tamanho de amostra 100 e via mínimos quadrados condicionais, temos o seguinte alpha médio: ", round(resultados_binomial_100$media_Minimos_Quadrados_condicionais[1], 4)," para o lambda Médio: ", round(resultados_binomial_100$media_Minimos_Quadrados_condicionais[2], 4))

paste0("Com tamanho de amostra 100 e via Máxima Verossimilhança Condicional, temos o seguinte alpha médio: ",   round(resultados_binomial_100$media_Maxima_verossimilhanca_condicional[1], 4)," para o lambda Médio: ", round(resultados_binomial_100$media_Maxima_verossimilhanca_condicional[2], 4))

paste0("Com tamanho de amostra 100 e via Mínimos Quadrados Condicionais, temos a variância do alpha: ", 
       round(resultados_binomial_100$variancia_Minimos_Quadrados_condicionais[1], 4), " e a variância para o lambda: ", 
       round(resultados_binomial_100$variancia_Minimos_Quadrados_condicionais[2], 4))

paste0("Com tamanho de amostra 100 e via Máxima Verossimilhança Condicional, temos a variância do alpha: ", 
       round(resultados_binomial_100$variancia_Maxima_verossimilhanca_condicional[1], 4), " e a variância para o lambda: ", 
       round(resultados_binomial_100$variancia_Maxima_verossimilhanca_condicional[2], 4))
```

```{r}
banco_binomial_100_min_quad <- as.data.frame(resultados_binomial_100[[5]])
banco_binomial_100_max_vero <- as.data.frame(resultados_binomial_100[[6]])
```
...
```{r, warning=FALSE, message=FALSE}
grafico_100_min_quad_lambda <- ggplot(banco_binomial_100_min_quad) +
 aes(x = V2) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_100_min_quad_alpha <- ggplot(banco_binomial_100_min_quad) +
 aes(x = V1) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density(
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_100_max_vero_lambda <- ggplot(banco_binomial_100_max_vero) +
 aes(x = V2) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_100_max_vero_alpha <- ggplot(banco_binomial_100_max_vero) +
 aes(x = V1) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density(
 alpha = 0.5, fill = "gray") +
...
```{r, message=FALSE, warning=FALSE}
resultados_binomial_300 <- simulacao_monte_carlo(n_simulacoes = 5000, n_amostra = 300, alpha_verdadeiro = 0.6, mu_verdadeiro = 2, sigma_verdadeiro = 3)

```

```{r}
paste0("Com tamanho de amostra 300 e via mínimos quadrados condicionais, temos o seguinte alpha médio: ", round(resultados_binomial_300$media_Minimos_Quadrados_condicionais[1], 4)," para o lambda Médio: ", round(resultados_binomial_300$media_Minimos_Quadrados_condicionais[2], 4))

paste0("Com tamanho de amostra 300 e via Máxima Verossimilhança Condicional, temos o seguinte alpha médio: ",   round(resultados_binomial_300$media_Maxima_verossimilhanca_condicional[1], 4)," para o lambda Médio: ", round(resultados_binomial_300$media_Maxima_verossimilhanca_condicional[2], 4))

paste0("Com tamanho de amostra 300 e via Mínimos Quadrados Condicionais, temos a variância do alpha: ", 
       round(resultados_binomial_300$variancia_Minimos_Quadrados_condicionais[1], 4), " e a variância para o lambda: ", 
       round(resultados_binomial_300$variancia_Minimos_Quadrados_condicionais[2], 4))

paste0("Com tamanho de amostra 300 e via Máxima Verossimilhança Condicional, temos a variância do alpha: ", 
       round(resultados_binomial_300$variancia_Maxima_verossimilhanca_condicional[1], 4), " e a variância para o lambda: ", 
       round(resultados_binomial_300$variancia_Maxima_verossimilhanca_condicional[2], 4))
```

```{r}
banco_binomial_300_min_quad <- as.data.frame(resultados_binomial_300[[5]])
banco_binomial_300_max_vero <- as.data.frame(resultados_binomial_300[[6]])
```
...
```{r, warning=FALSE, message=FALSE}
grafico_300_min_quad_lambda <- ggplot(banco_binomial_300_min_quad) +
 aes(x = V2) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_300_min_quad_alpha <- ggplot(banco_binomial_300_min_quad) +
 aes(x = V1) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_300_max_vero_lambda <- ggplot(banco_binomial_300_max_vero) +
 aes(x = V2) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_300_max_vero_alpha <- ggplot(banco_binomial_300_max_vero) +
 aes(x = V1) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density(
...
```{r, message=FALSE, warning=FALSE}
resultados_binomial_500 <- simulacao_monte_carlo(n_simulacoes = 5000, n_amostra = 500, alpha_verdadeiro = 0.6, mu_verdadeiro = 2, sigma_verdadeiro = 3)

```

```{r}
paste0("Com tamanho de amostra 500 e via mínimos quadrados condicionais, temos o seguinte alpha médio: ", round(resultados_binomial_500$media_Minimos_Quadrados_condicionais[1], 4)," para o lambda Médio: ", round(resultados_binomial_500$media_Minimos_Quadrados_condicionais[2], 4))

paste0("Com tamanho de amostra 500 e via Máxima Verossimilhança Condicional, temos o seguinte alpha médio: ",   round(resultados_binomial_500$media_Maxima_verossimilhanca_condicional[1], 4)," para o lambda Médio: ", round(resultados_binomial_500$media_Maxima_verossimilhanca_condicional[2], 4))

paste0("Com tamanho de amostra 500 e via Mínimos Quadrados Condicionais, temos a variância do alpha: ", 
       round(resultados_binomial_500$variancia_Minimos_Quadrados_condicionais[1], 4), " e a variância para o lambda: ", 
       round(resultados_binomial_500$variancia_Minimos_Quadrados_condicionais[2], 4))

paste0("Com tamanho de amostra 500 e via Máxima Verossimilhança Condicional, temos a variância do alpha: ", 
       round(resultados_binomial_500$variancia_Maxima_verossimilhanca_condicional[1], 4), " e a variância para o lambda: ", 
       round(resultados_binomial_500$variancia_Maxima_verossimilhanca_condicional[2], 4))
```

```{r}
banco_binomial_500_min_quad <- as.data.frame(resultados_binomial_500[[5]])
banco_binomial_500_max_vero <- as.data.frame(resultados_binomial_500[[6]])
```
...
```{r, warning=FALSE, message=FALSE}
grafico_500_min_quad_lambda <- ggplot(banco_binomial_500_min_quad) +
 aes(x = V2) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_500_min_quad_alpha <- ggplot(banco_binomial_500_min_quad) +
 aes(x = V1) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_500_max_vero_lambda <- ggplot(banco_binomial_500_max_vero) +
 aes(x = V2) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
...
```{r, warning=FALSE, message=FALSE}
grafico_500_max_vero_alpha <- ggplot(banco_binomial_500_max_vero) +
 aes(x = V1) +
 geom_histogram(aes(y = ..density..), bins = 60L, fill = "#46B47A", color = "black") +
 geom_density( 
 alpha = 0.5, fill = "gray") +
